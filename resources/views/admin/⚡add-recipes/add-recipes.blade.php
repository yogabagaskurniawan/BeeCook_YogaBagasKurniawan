<div>
    <main class="relative px-6 md:px-[123px] py-10 pt-[126px]">
        ...
        <!-- Alert Success -->
        @if ($successMessage)
            <div class="mb-6 flex items-center gap-3 bg-green-50 border border-green-200 text-green-700 px-5 py-4 rounded-xl font-inter text-sm">
        ...
        <!-- Alert Error -->
        @if ($errorMessage)
            <div class="mb-6 flex items-center gap-3 bg-red-50 border border-red-200 text-red-700 px-5 py-4 rounded-xl font-inter text-sm">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
